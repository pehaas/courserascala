...
object InfixOperator {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(89); 
  
  val r13 = new Rational(1,3);System.out.println("""r13  : _2_7_functions_and_data.Rational = """ + $show(r13 ));$skip(30); 
  val r32 = new Rational(3,2);System.out.println("""r32  : _2_7_functions_and_data.Rational = """ + $show(r32 ));$skip(78); val res$0 = 
  
  //Instead of writing r12.add(r32) you can do the following
  r13 add r32;System.out.println("""res0: _2_7_functions_and_data.Rational = """ + $show(res$0))}
